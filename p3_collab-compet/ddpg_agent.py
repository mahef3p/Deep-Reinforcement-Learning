...
class Agent:
    ...
    def step(self, states, actions, rewards, next_states, dones):
        ...
        # Learn every UPDATE_STEPS time steps if enough samples are available in memory
        if (self.t_step % UPDATE_STEPS == 0) and (len(self.memory) > BATCH_SIZE):
    ...
    def learn(self, experiences, gamma):
        ...
        # update epsilon
        self.epsilon = max(0.01, self.epsilon - NOISE_DECAY)
